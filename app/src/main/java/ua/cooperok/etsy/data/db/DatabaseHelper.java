...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_LISTINGS = "CREATE TABLE " + TABLE_LISTINGS + "("
            ...
            + KEY_SAVED_STATE + " INTEGER DEFAULT 0)";
    ...
    /**
     * SELECT * FROM listings WHERE state = 1 LIMIT 0, 20
     */
    public static final String SELECT_SAVED_LISTINGS = "SELECT * FROM " + TABLE_LISTINGS + " WHERE " + KEY_SAVED_STATE + " = 1";
    ...
    public void onCreate(SQLiteDatabase db) {
        Log.i("test", "DatabaseHelper.onCreate (line 85): " + CREATE_TABLE_CATEGORIES);
        Log.i("test", "DatabaseHelper.onCreate (line 87): " + CREATE_TABLE_LISTINGS);
        Log.i("test", "DatabaseHelper.onCreate (line 88): " + CREATE_TABLE_LISTINGS_IMAGES);
